		...
		<form id="forma" action="" method="post" enctype="multipart/form-data">
					...
					<table align="center" width="750">
						...
						<tr align="center">
							<td colspan="6"><h2 id="udateh2">Update your Account</h2></td>
						</tr>
						
						<tr>
							<td align="right"><p>Customer Name:</p></td>
							<td><input type="text" name="c_name" value="<?php echo $name;?>" required/></td>
						</tr>
						
						<tr>
							<td align="right"><p>Customer Email:</p></td>
							<td><input type="text" name="c_email" value="<?php echo $email;?>" required/></td>
						</tr>
						
						<tr>
							<td align="right"><p>Customer Password:</p></td>
							<td><input type="password" name="c_pass" value="<?php echo $pass;?>" required/></td>
						</tr>
						
						<tr>
							<td align="right"><p>Customer Image:</p></td>
						...
						<tr>
							<td align="right"><p>Customer Country:</p></td>
							<td>
						...
						<tr>
							<td align="right"><p>Customer City:<p></td>
							<td><input type="text" name="c_city" value="<?php echo $city;?>"/></td>
						</tr>
						
						<tr>
							<td align="right"><p>Customer Contact:</p></td>
							<td><input type="text" name="c_contact" value="<?php echo $contact;?>"/></td>
						</tr>
						
						<tr>
							<td align="right"><p>Customer Address<p></td>
							<td><input type="text" name="c_address" value="<?php echo $address;?>"/></td>
						</tr>
						
						
					<tr align="center">
						<td colspan="6"><input id="update" type="submit" name="update" value="Update Account" /></td>
					</tr>
