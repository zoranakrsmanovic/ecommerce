...
if(isset($_GET['edit_pro'])){
	...
	$row_pro=mysqli_fetch_array($run_pro);
		...
		$get_cat = "select * from category where category_id='$pro_cat'";
...
<body bgcolor="skyblue">
	...
	<form action="" method="post" enctype="multipart/form-data"> 
		...
		<table align="center" width="700" border="2" bgcolor="#187eae">
			
			<tr align="center">
				<td colspan="7"><h2 style="font-size:25px;color:white;font-family: 'Montserrat', sans-serif; font-weight:lighter; margin-left:50px; margin-bottom:10px;">Edit & Update Product</h2></td>
			</tr>
	...
	while ($row_brands=mysqli_fetch_array($run_brands)){
		...
		$brand_title = $row_brands['brant_title'];
	...
	echo "<option value='$brand_id'>$brand_title</option>";
			...
			<tr>
				...
				<td><input type="file" name="product_image" /><img style="margin-top:10px;" src="product_images/<?php echo $pro_image; ?>" width="60" height="60"/></td>
			</tr>
			...
			<tr align="center">
				<td colspan="7"><input id="submit_login" type="submit" name="update_product" value="Update Product"/></td>
			</tr>
...
<?php 
	...
	if(isset($_POST['update_product'])){
		...
		move_uploaded_file($product_image_tmp,"product_images/$product_image");
		 ...
		 $update_product = "UPDATE product SET product_category=$product_cat, product_brand=$product_brand, product_title=$product_title, product_price=$product_price, product_desc=$product_desc, product_image=$product_image, product_keywords=$product_keywords WHERE product_id=$update_id";
